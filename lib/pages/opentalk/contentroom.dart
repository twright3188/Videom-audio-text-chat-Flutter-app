...
class ContentRoom extends StatefulWidget {
  const ContentRoom({Key? key, required this.callback, required this.data_list})
      : super(key: key);
  final Function(Map<String, dynamic>, int) callback;
  final List<Map<String, dynamic>> data_list;
  @override
  State<ContentRoom> createState() => _ContentRoom();
}

class _ContentRoom extends State<ContentRoom> {
  @override
