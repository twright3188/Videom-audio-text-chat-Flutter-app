...
import 'package:crepe/pages/chatrequest/chatbid3.dart';
import 'dart:async';

class ChatBid2 extends StatefulWidget {
  const ChatBid2({Key? key, required this.methodIdx}) : super(key: key);
  final int methodIdx;
  @override
  State<ChatBid2> createState() => _ChatBid2();
}

class _ChatBid2 extends State<ChatBid2> {
  var crepeCnt = 0;
  var timer;
                ...
                child: FilledButton(
                    onPressed: () {
                      Navigator.of(context).push(
                          CreateRoute(ChatBid3(methodIdx: widget.methodIdx)));
                    },
