...
//콜 요청 페이지 3(스타 옥션)
class CallBid3 extends StatefulWidget {
  const CallBid3({Key? key, required this.methodIdx}) : super(key: key);
  final int methodIdx;
  @override
  State<CallBid3> createState() => _CallBid3();
}

class _CallBid3 extends State<CallBid3> {
  var crepeCnt = 0;
  @override
  void initState() {
    super.initState();
