...
import 'package:crepe/pages/callrequest/callbid33.dart';

//콜 요청 페이지 2(럭키드로우)
class CallBid22 extends StatefulWidget {
  const CallBid22({Key? key, required this.methodIdx}) : super(key: key);
  final int methodIdx;
  @override
  State<CallBid22> createState() => _CallBid22();
}

class _CallBid22 extends State<CallBid22> {
  var crepeCnt = 0;
  @override
  void initState() {
    super.initState();
                ...
                child: FilledButton(
                    onPressed: () {
                      Navigator.of(context).push(
                          CreateRoute(CallBid33(methodIdx: widget.methodIdx)));
                    },
