...
//콜 요청 페이지 3(럭키드로우)
class CallBid33 extends StatefulWidget {
  const CallBid33({Key? key, required this.methodIdx}) : super(key: key);
  final int methodIdx;
  @override
  State<CallBid33> createState() => _CallBid33();
}

class _CallBid33 extends State<CallBid33> {
  var crepeCnt = 0;
  @override
  void initState() {
    super.initState();
